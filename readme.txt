...
4 - The Difficulty is increasing : Please solve tests one by one, we would like to see your approach of solving the problem;  we do not want the perfect solution.
...
6 - Anyone can make mistakes... but this kata has been run literally hundreds of times. If something feels odd it's very unlikely that it would be coming from the exercise. 
7 - You're not allowed to change the tests.
